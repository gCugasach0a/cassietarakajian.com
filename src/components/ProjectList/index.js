...
const ProjectList = () => (
  <ul className={styles.items}>
    ...
    <li className={styles.item}>
      ...
      <div>
        <h2>
          Creator and Lead Maintainer, <a href="https://editor.p5js.org" target="_blank" rel="noreferrer">p5.js Web Editor</a>
        </h2>
        <p>
      ...
      <div>
        ...
        <p>
          <ul>
            ...
            <li>
              <a href="https://github.com/itp-dwd/2020-spring" target="_blank" rel="noreferrer">Dynamic Web Development</a>, Spring 2020 [WIP Curriculum]
            </li>
          </ul>
        </p>
      </div>
